...
open class CameraManager: NSObject, AVCaptureFileOutputRecordingDelegate, UIGestureRecognizerDelegate {
    ...
    open var cameraOutputMode: CameraOutputMode = .videoWithMic {
        didSet {
            if cameraIsSetup {
     ...
     */
    @objc @discardableResult open func addPreviewLayerToView(_ view: UIView) -> Int {
        return addPreviewLayerToView(view, newCameraOutputMode: 2)
    }

    @objc @discardableResult open func addPreviewLayerToView(_ view: UIView, newCameraOutputMode: Int) -> Int {
        return addLayerPreviewToView(view, newCameraOutputMode: 2, completion: nil)
    }

    @objc @discardableResult open func addLayerPreviewToView(_ view: UIView, newCameraOutputMode: Int, completion: (() -> Void)?) -> Int {
        if _canLoadCamera() {
     ...
     */
    @objc open func askUserForCameraPermission(_ completion: @escaping (Bool) -> Void) {
     ...
     */
    @objc open func stopAndRemoveCaptureSession() {
        stopCaptureSession()
    ...
    /**
     ...
     :returns: Current state of the camera: Ready / AccessDenied / NoDeviceFound / NotDetermined
     */
    open func currentCameraStatus() -> Int {
        return _checkIfCameraIsAvailable()
    }
    ...
    @objc open func resetOrientation() {
    ...
    fileprivate func _canLoadCamera() -> Bool {
        ...
        return currentCameraState == 0 || (currentCameraState == 3 && showAccessPermissionPopupAutomatically)
    }
    ...
    fileprivate func _checkIfCameraIsAvailable() -> Int {
